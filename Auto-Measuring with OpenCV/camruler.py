...
while 1:
    ...
    # -------------------------------
        ...
        for c in contours:
            ...
            # add Grading and RGB
            if (xlen > 71.0 or ylen > 71.0):
                cv2.putText(frame0, f'Grade: A', (1000, 100),
                            cv2.FONT_HERSHEY_COMPLEX, 1, (128, 0, 0), 2)
                cv2.putText(frame0, f'R/G: {str(r_ratio)}', (1000, 150),
                            cv2.FONT_HERSHEY_COMPLEX, 1, (128, 0, 0), 2)

            elif ((xlen >= 61.0 or ylen >= 61.0)) & ((xlen <= 70.9 or ylen <= 70.9)):
                cv2.putText(frame0, f'Grade: B', (1000, 100),
                            cv2.FONT_HERSHEY_COMPLEX, 1, (128, 0, 0), 2)
                cv2.putText(frame0, f'R/G: {str(r_ratio)}', (1000, 150),
                            cv2.FONT_HERSHEY_COMPLEX, 1, (128, 0, 0), 2)

            elif ((xlen >= 51.0 or ylen >= 51.0)) & ((xlen <=60.9 or ylen <=60.9 )):
                cv2.putText(frame0, f'Grade: C', (1000, 100),
                            cv2.FONT_HERSHEY_COMPLEX, 1, (128, 0, 0), 2)
                cv2.putText(frame0, f'R/G: {str(r_ratio)}', (1000, 150),
                            cv2.FONT_HERSHEY_COMPLEX, 1, (128, 0, 0), 2)
            
            elif ((xlen >= 41.0 or ylen >= 41.0)) & ((xlen <=50.9 or ylen <=50.9)):
                cv2.putText(frame0, f'Grade: D', (1000, 100),
                            cv2.FONT_HERSHEY_COMPLEX, 1, (128, 0, 0), 2)
                cv2.putText(frame0, f'R/G: {str(r_ratio)}', (1000, 150),
                            cv2.FONT_HERSHEY_COMPLEX, 1, (128, 0, 0), 2)

            else:
                cv2.putText(frame0, f'Grade: Abnormal', (1000, 100),
                            cv2.FONT_HERSHEY_COMPLEX, 1, (128, 0, 0), 2)
                cv2.putText(frame0, f'R/G: {str(r_ratio)}', (1000, 150),
                            cv2.FONT_HERSHEY_COMPLEX, 1, (128, 0, 0), 2)
            print(ratio)
